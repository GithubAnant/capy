...
function buildPreviewBriefSchema() {
    return {
        ...
        deliverable_spec: z.object({
            ...
            layout_guidelines: z.array(z.string()),
...
function toStructuredPreviewBrief(brief) {
    return {
        ...
        deliverable_spec: {
            ...
            layout_guidelines: brief.deliverableSpec.layoutGuidelines,
            design_guidance: {
                page_structure: brief.deliverableSpec.designGuidance.pageStructure,
                whitespace: brief.deliverableSpec.designGuidance.whitespace,
                typography: brief.deliverableSpec.designGuidance.typography,
                cards: brief.deliverableSpec.designGuidance.cards,
                color: brief.deliverableSpec.designGuidance.color,
                specimens: brief.deliverableSpec.designGuidance.specimens,
                responsive: brief.deliverableSpec.designGuidance.responsive,
            },
        },
