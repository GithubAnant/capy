...
export async function scanTailwind(projectRoot: string): Promise<TailwindResult> {
  const result: TailwindResult = { colors: [], spacing: [], typography: [] };
  ...
  try {
    ...
    // Colors
    const colors = {
      ...(flattenObject((theme.colors || {}) as Record<string, unknown>)),
      ...(flattenObject((extend.colors || {}) as Record<string, unknown>)),
    };
    ...
    // Spacing
    const spacing = {
      ...(flattenObject((theme.spacing || {}) as Record<string, unknown>)),
      ...(flattenObject((extend.spacing || {}) as Record<string, unknown>)),
    };
    ...
    const fontFamily = {
      ...(flattenObject((theme.fontFamily || {}) as Record<string, unknown>)),
      ...(flattenObject((extend.fontFamily || {}) as Record<string, unknown>)),
    };
    ...
    const fontSize = {
      ...(flattenObject((theme.fontSize || {}) as Record<string, unknown>)),
      ...(flattenObject((extend.fontSize || {}) as Record<string, unknown>)),
    };
...
function extractConfigFromSource(content: string): Record<string, unknown> {
