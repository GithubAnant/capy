    ...
    <section id="pricing" className="relative pb-20 pt-12">
      ...
      <div className="mt-10 grid w-full gap-4 md:grid-cols-[0.85fr_1fr]">
        ...
        <div className="rounded-[1.3rem] bg-[#171615] px-7 py-7 md:px-8 md:py-8">
          ...
          <div className="mt-6">
            <p className="text-[0.82rem] leading-normal text-[#858585]">
            ...
            <div className="mt-3 flex flex-wrap items-center gap-2.5">
              <a
                ...
                className="inline-flex items-center gap-2 rounded-lg bg-[#F0F0F3] px-3.5 py-2 text-[0.8rem] font-medium text-[#0b0b0e] hover:bg-white"
              >
