  ...
  return (
    <section className="pb-7 pt-16 text-center md:pb-10 md:pt-20">
      ...
      <div className="mt-5 flex items-center justify-center gap-3.5">
        <button
          type="button"
          className="rounded-full bg-[#F0F0F3] px-3.5 py-1.5 text-[0.82rem] font-medium text-[#0f0f14] transition-colors duration-300 hover:bg-white"
        >
          Download for macOs
        </button>
        <a href="#" className="text-[0.82rem] font-medium text-[#F0F0F3]">
          Discover product
        </a>
      </div>
    </section>
